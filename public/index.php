...
<head>
  ...
  <style>
    ...
    .mesh{
      ...
      filter:drop-shadow(0 0 35px rgba(124,196,255,.25));
      pointer-events:none;
    }
    .mesh.mesh--left{
    ...
    .brand-sub{
      font-size:16px;
      opacity:.9;
      border-top:2px solid rgba(124,196,255,.35);
    ...
    .card{
      ...
      box-shadow:0 8px 24px rgba(33,37,41,.06);
      background:#fff;
    }
...
<body>
    ...
    <div class="hero-inner container">
      ...
      <div class="hero-right">
        ...
        <div class="hero-actions">
          <span class="text-light">Hola, <?= h($displayName) ?></span>
          <a class="btn btn-outline-secondary btn-sm" href="/ParteOficialTurno/logout.php">Salir</a>
        </div>
      </div>
    ...
    <div class="container">
      ...
      <div class="card mb-4">
        <div class="card-body">
          ...
          <div class="mb-4">
            <button class="btn btn-outline-primary btn-sm" id="btnConfirmSistemas">
              Confirmar sistemas (revisado)
            </button>
          </div>
  ...
  (function () {
    ...
    const listo = () => [fDesde,fHasta,fOfi,fSub].every(el =>
    ...
    btnGen.addEventListener('click', function () {
      ...
      if (!listo()) {
        alert('Completá fechas y encabezado.');
        return;
      }
